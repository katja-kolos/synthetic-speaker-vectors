# adapted from https://github.com/Voice-Privacy-Challenge/Voice-Privacy-Challenge-2024/blob/main/anonymization/modules/sttts/speaker_embeddings/anonymization/utils
    ...
    for cycle in range(parameters["cycles"]):
        ...
        if (cycle + 1) % save_vis_every == 0:
            ...
            if parameters['normalize_data']:
                ...
                samples_generated = model.sample_generator(num_samples=10, nograd=True).cpu()
