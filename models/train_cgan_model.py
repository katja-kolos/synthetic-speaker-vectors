...
from cWGAN.dataset import SpeakerVectorGenderDataset2
from cWGAN.training.train_cwgan import train_cgan
from cWGAN.training.logger import setup_logger, setup_tensorboard
...
def get_args():
    ...
    parser.add_argument("--config", type=str, default="./cWGAN/configs/train_gan.json")
